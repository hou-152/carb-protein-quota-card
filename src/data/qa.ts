// 问答数据来源：B 站「好人松松」健身 Excel 超级套表（25 年 9 月版）第 17/18 张表。
// 仅作生活化饮食参考，不构成医疗建议。

export type QaCategory = "fat-loss" | "muscle-gain";
...
export const qaData: Record<QaCategory, QaItem[]> = {
  "fat-loss": [
    {
      q: `执行了2周但体重不掉该怎么调整？`,
      a: `表格设计的热量缺口已比较大了，如果体重2周不掉，首先要怀疑的不是表格设计的问题，而是表格执行的问题。常见的不能执行表格的原因：
...
确认不存在上述问题后，才考虑是热量缺口不足的问题，办法是：a.要么每天比原食谱少吃200大卡（150g米饭+1个全蛋）（感觉不太饿的建议用这个办法） b.要么参考配套的《有氧热量消耗表》每周多做1000大卡有氧（但不要加饮食）（小体重者和感觉饿的建议用这办法而非削减饮食）。这样再执行1-2周来看体重变化。再次强调，多数人其实不是表格设计有问题，而是无法执行表格，所以需要先检查上述问题！`,
    ...
    {
      q: `减脂到多少体重就应该停止了？`,
      a: `建议男性BMI22-23、女性BMI20-21就停止减脂（BMI=体重kg÷身高m÷身高m）。
...
但是，如果你已经减到了上述建议的BMI，却仍有这几种情况，则建议继续减脂一些直到症状消除：①此时仍有向心肥胖趋势（空腹肚脐一线腰围 不鼓肚子也不吸肚子 男性>85cm 女性>80cm）②此时仍有脂肪肝 ③此时仍有二型糖尿病/胰岛素抵抗。这些是很少数人的情况，可以突破上述建议的BMI范围，继续减脂一些直到身体康复。`,
    ...
    {
      q: `为什么新手初期要定量饮食？`,
      a: `因为新手对日常食物的碳蛋脂量没有概念，按感觉吃饭大概率会导致碳蛋脂的总量严重错误。如果按感觉吃饭能八九不离十，那大家也不会有减肥问题了。在对照教程视频（B站里搜BV1zu4m1N76R），用本套表的饮食表算好食物重量后，你需要买个食物称，在初期（用几天到一周的时间）做定量饮食。建立饮食习惯后就不需要定量饮食了。这个步骤是必要的。`,
    },
    {
      q: `难道要一直称重吃饭？食物是生重还是熟重？`,
      a: `不要理解成一直天天顿顿用食物称来称重，而是初期把你经常性食物测一下就行了：
...
生熟问题：米饭、面条的生熟重量差别很大，所以表格里生熟重量都写了，一定要分清；燕麦片、燕麦麸皮是指干重，不是指加水后的重量，因为每个人加水量是任意的；玉米、土豆、红薯的生熟重量差别不大，所以无需区分生熟。`,
    ...
    {
      q: `是否有一些固定重量的食物？`,
      a: `大部分食物不是全国统一重量的，仍需自己定量，比较固定重量的食物只有以下这些：
...
日常基础食物的营养率，详见饮食配套视频第23分10秒，或本表的第19个表格《日常食物营养率》）`,
    ...
    {
      q: `表格里哪些食物如果不定量会被严重错估？`,
      a: `【面条/米线/卷饼（烙饼、炊饼、馕等）】容易被低估碳水量。这些是饱腹感最低的主食，减脂一般不作为常规主食，一份的碳水量高达80-160g，一顿能吃很多但还感觉不出来。除非是饮食配额很高的大体重者，否则减脂期一般不用这些主食作为碳水来源。如果经常要吃，请务必自己定量一次。碳水率：熟面条23%，凉面和米线33%，未下锅的生鲜面50%，未下锅的干面70%，卷饼（烙饼、炊饼、馕等）50%。
...
【个别特殊菜肴】容易被低估脂肪量。绝大部分家常菜带油是无妨的，但个别几道菜需要回避：a.炒鸡蛋（例如西红柿炒鸡蛋），一个鸡蛋加上吸油量脂肪动辄30g，会花完全天脂肪配额的一半甚至更多，一定要回避。如果非吃炒鸡蛋不可，请自己在家用两三克油去做。b.炒茄子，茄子是能极度吸油，倒多少油进去，起锅时会被吸干，一般回避这道菜。c.油炸菜，如炸蘑菇、炸酥肉、炸鸡炸鱼炸虾、猪大排（大排也是先油炸过的）。`,
    ...
    {
      q: `哪些食物需要特别提醒？`,
      a: `【瘦肉】减脂期的肉类要严格确保是瘦肉，瘦肉的脂肪率一般低于5%，基本只有：没有白色脂肪层的猪牛羊肉+去皮的鸡鸭肉+鱼虾+肝肾肚血心。
...
【关于菜肴里的油】一般的带油烧菜不用害怕，但夹起来会直接淌油的重油菜肴（例如水煮牛肉、口水鸡等），除了确保肉类本身必须是瘦肉外，还要把菜肴在盘边或盘里刮一刮（甚至简单过下水都行），让附着的油量少一些，而不要直接淌着油就往嘴里送。`,
    ...
    {
      q: `吃外卖该怎么办？`,
      a: `【正确的外卖】用主食+瘦肉模式的外卖是最简单的，例如黄焖鸡、海南鸡、酸菜鱼、跷脚牛肉、鸡腿饭、瘦肉炒菜配米饭等，初期把主食和瘦肉重量都定量把握一下。最重要的是，必须是瘦肉而不能是高脂肉（五花肉、猪大排、糖醋里脊、锅包肉、鸡翅、猪蹄、肥牛肥羊、肉馅肉饼肉丸等），碳水则推荐米饭（面条、米线、卷饼等虽然也是碳水，但饱腹感很低）。外卖米饭，长方形饭盒大约是100g碳水/盒。
...
【错误的外卖】①缺乏瘦肉的外卖，比如面条、米线、盖饭；②混合餐外卖，比如轻食、健康餐，N种食物全部搅拌在一起，让你难以定量；③高脂肉外卖：肉类只能吃瘦肉，高脂肉必须能识别和回避，包括大排、糖醋里脊、锅包肉、鸡翅、猪蹄、牛腩、牛排、排骨、烤肉、炸肉、午餐肉、肥牛、肥羊、肉肠、肉饼、肉馅、肉丸等。`,
    ...
    {
      q: `食堂外卖餐馆的瘦肉量不够怎么办？`,
      a: `吃食堂/外卖/餐馆，容易缺乏瘦肉而蛋白质摄入不足。如果你只能找到一些高脂肉（表格里“脂肪”那列红字举例了，那些是不能吃的），怎么补足蛋白质呢？
...
③蛋白粉，我B站橱窗有各种大小包装的，蛋白粉的蛋白质率高达75%，蛋白粉10g=表格里熟瘦肉30g。当然此处并非广告，你也可以在各品牌官方店购买，但注意不要错买成增肌粉了。`,
    ...
    {
      q: `在外就餐怎么办？`,
      a: `在外就餐不影响减脂。在外就餐桌上摆的还是碳蛋脂，只是无法定量而已，影响不大。碳水量参考你既往的主食量来吃即可，瘦肉量可以比较随意，蔬菜随意。
...
特别需要注意的就是少吃不吃【高脂肉】和【糖油混合物】（具体举例请看饮食表格“脂肪”那列的红字讲解）。例如，一般中餐你就吃瘦肉菜肴，配上主食和蔬菜。火锅就吃瘦牛肉、鱼虾等，配上主食和蔬菜。切勿去找五花肉、肥牛、肥羊、炸酥肉、炸馒头、炸糍粑、锅盔等来吃。减脂饮食在任何场合都少吃不吃高脂肉和糖油混合物，最多就是浅尝解馋而已，这样脂肪摄入才不会爆炸，这是减脂期的重中之重。`,
    ...
    {
      q: `减脂期需要吃放纵餐吗？`,
      a: `我们的饮食方案，每餐都是主食（量还行）+你喜欢的瘦肉菜、蔬菜（什么菜系、做法都可以，只需要是瘦肉而非高脂肉），排除的食物就只有糖油混合物和高脂肉而已，所以就不痛苦，在如此宽松的饮食里，也不需要定期去“放纵”来“缓解痛苦”。在外就餐并不是“放纵”，主食量参考在家吃饭的量，比如你在家吃多大体积的米饭，你在外也吃那么多，不需要称量，大概即可；瘦肉菜随便吃，不限制，吃瘦肉不叫放纵；但一切高脂肉、糖油混合物（详见饮食表格里“脂肪”那列的红字举例的食物）基本不要碰，最多尝几口。

不过，如果你的饮食习惯是，不吃高脂肉，不吃糖油混合物，就会陷入痛苦，那你确实可以定期去“放纵”吃这些，但因为热量确实高，不可避免会影响减脂，这件事就自己取舍了。`,
    },
    {
      q: `为什么喝酒对减脂的破坏很大？必须喝酒该怎么办？`,
      a: `①酒的热量来自酒精，非常高！
...
先试算出自己每周的酒精热量，再用增加等量的有氧量去对冲。例如，每周需要喝白酒5两，当周就额外做有氧：5两×200大卡=1000大卡，有氧热量消耗参考配套的《氧热量消耗》表。一般不建议用减碳水的办法去对冲酒精热量，因为本表设计的碳水量不算多，用碳水量来对冲喝酒热量的话，碳水量会锐减，很可能低于人体需求的基本碳水量（除非你的基础体重相当大，你应吃的碳水总量本身就很高，所以用来对冲一些酒精也无妨）。`,
    ...
    {
      q: `大体重减脂下降10kg后该怎么调整饮食量？`,
      a: `目标体重参考饮食表开头的“减到何时”一行，或本表的问答2。人体基础代谢是会随体重下降而正常下降的，大约是每降低10kg体重，基础代谢会下降100+大卡。因此，体重比初始下降10kg，为了防止热量缺口被抹平，你需要：①如果觉得目前不饿，就每天比本食谱少吃100g米饭+1个全蛋 ②如果觉得减饮食会饿，就参考配套的《有氧热量消耗》表每周多做800大卡有氧（但不要因此去加饮食）。再减10kg体重的时候，你就再这样操作一次。`,
    },
    {
      q: `改了力训时间该怎么修改力训日的餐序？`,
      a: `表格设计了多种力训时间的饮食表，各表的饮食总量是相同的，但分餐顺序不同。逻辑是：力训练前不能空腹，要有垫肚子的进食，力训练后要吃全天最大一次练后餐。如果你要换力训时间，直接去套用不同的饮食表即可。各饮食表的分餐顺序是：
...
【晚饭后更晚练】早饭-午饭（其他餐）-晚饭（其他餐）-训练-练后餐  *各餐可以比较均摊，练后餐稍大一点即可，否则白天会太饿`,
    ...
    {
      q: `减脂期间感觉饿怎么办？`,
      a: `①最重要的是选择高饱腹感主食。表格提供的可选主食里，尽量选择饱腹感高的：米饭、燕麦麸、燕麦片、土豆、红薯、玉米；饱腹感一般的：面包、馒头花卷；放弃饱腹感特低的：面条、米线、卷饼（烙饼、炊饼、馕等）。
...
本身就有爱好性有氧（比如长期爱好打球、跑步等），或被迫有氧（比如工作必须每天走路几千上万步，学生必须跑步打卡），则无论体重大小，都应该保留这种有氧。但也提醒，每周有氧时长特大的（例如每周超过3000大卡），会让饮食量对应增加得很厉害，容易吃不下，而且属于是近乎全部用有氧来提供热量缺口，饮食不做任何帮忙，这种减脂方式是很不建议的（一旦停止有氧，就会变成热量盈余长体重），如有可能还是建议削减有氧，除非是非做不可。`,
    ...
    {
      q: `为什么低热量节食后用本方案体重会增加？`,
      a: `所谓“低热量节食”，是指每天饮食热量远低于基础代谢水平的饮食方式（本表热量设计已经够低，如果你之前吃得比本表还少得多，就属于此）。经历过低热量节食减肥的人群，肌糖原重量以及肌糖原的储水重量都比较低，再加上基础代谢可能有所损害，所以一旦恢复到正常碳水量和总热量的减脂饮食后，肌糖原重量以及肌糖原的储水重量都会提高，所以体重可能会在第一周不降反升。

低热量节食群体必须接受这个过程，把肌糖原、储水、基础代谢都恢复到正常水平后，才能像普通人那样开始正常减脂。如果因为恐惧体重上升而不敢放弃节食，那是饮鸩止渴、自欺欺人的做法。`,
    },
    {
      q: `为什么体脂称/体测仪的体脂和肌肉数据是不可信的？`,
      a: `生物抗阻抗法的体脂称/体测仪的数据只有体重有用，骨骼肌、体脂肪数据都不要当真。基础代谢也不是“测”出来的，而是根据你的体重代入内置的公式计算的（就像我们表格里代入你的体重预测基础代谢一样）。
...
如果确实非常关心自己的脂肪和肌肉量，一定要得到一个可靠的数字，可以去医院挂营养科或者骨科，要求用“双能X射线吸收法”（DEXA）测身体成分，这个机器本身是用于测骨密度的，因此一般医院都能做，价格不贵约100元左右。但此法只用于那些一定要得知自己身体成分数字的人，并不是增肌减脂就需要去测。`,
    ...
    {
      q: `为什么两三天的体重变化没有意义？`,
      a: `影响每日体重变化的因素：①未排出的食糜。食物消化排出需要1-4天，每天食物重量不同（比如某天吃得多、某天少吃一顿），会影响接下来数天的食糜重量，能显著改变体重；②人体脱水吸水。较低的盐分摄入能导致人体脱水掉体重，较高的盐分摄入能导致人体吸水长体重，每天吃盐量不同，就会影响体重；③脂肪的分解合成。这是大家关心的，但非常微弱，即便在正确减脂，每天脂肪分解量也不过三五十克，占全天体重变化的比例只有百分之几而已！
...
所以，你可以经常称体重，但有意义的体重比较，应该用1-2周的变化来对比。两三天里体重增加了，不代表你增脂了，体重降低了，也不代表你减脂了。`,
    ...
    {
      q: `为什么管理碳蛋脂后就不做16+8轻断食了？`,
      a: `轻断食是对完全搞不清楚碳蛋脂的超级小白比较合适的一种办法。
...
所以，轻断食适合的是完全搞不清楚碳蛋脂的超级小白，而对于能管理碳蛋脂的人来说（本方案就是给你管理碳蛋脂的），就不要用轻断食那种简单办法了，更精准有效。`,
    ...
    {
      q: `高尿酸/痛风患者建议怎样处理饮食？`,
      a: `蛋白质来源里鸡蛋、牛奶、蛋白粉是没嘌呤的，肉类里猪牛羊嘌呤较低，建议：
...
③很重要的是各餐一定要多吃、先吃蔬菜，再吃肉，最后吃主食，这样能有效地压制血糖。`,
    ...
    {
      q: `为什么不要追求增肌减脂同时进行？`,
      a: `增肌减脂确实可以同时进行，比如一个刚开始力训的新手，即便Ta用的是减脂饮食配额让体重下降，Ta的肌肉量仍然可能是略微增长的，但这种增肌量和用增肌饮食配额是不能比的。
...
健身的实质就是通过增肌减脂的循环，来改变既定体重的肌肉率和脂肪率，继而改善体型。增肌期，肌肉和脂肪同时增长。减脂期，在肌肉很少损失乃至不损失（新手甚至能肌肉微增），同时脂肪大量分解。如此循环以后，你既定体重的肌肉率就提高率，脂肪率就下降了，就比以前好看了，然后又进入下一轮的循环。`,
    ...
    {
      q: `有什么低热量能短暂填肚子的零食？`,
      a: `餐间或睡前觉得饿，首先考虑优化正餐：a.正餐主食尽量选择饱腹感高的：米饭、燕麦麸、燕麦片、土豆、红薯、玉米，而不要选择饱腹感特低的：面条、米线、卷饼（烙饼、炊饼、馕等）；b.正餐多吃蔬菜，几乎无热量但能提供一些饱腹感。在此之外，餐间或夜宵还想吃东西，可以考虑以下零食：
...
无糖气泡饮料（能短暂填肚子，节约碳水配额，糖饮料爱好者必须转为喝代糖饮料）`,
    ...
    {
      q: `有什么可以用于练前练后餐的便携碳水？`,
      a: `便携碳水主要用于练前餐（练前餐就是一份垫肚子的小碳水）。练后餐如果吃正餐不方便，也可以用便携碳水+蛋白粉，但饱腹感往往会比较低。
...
*更多便携碳水、方便食品，参见本表第19表《日常食物营养率》的碳水食物清单`,
  ...
  "muscle-gain": [
    {
      q: `执行了一个月但体重不长该怎么调整？`,
      a: `增肌期体重的建议增速，男性每月体重增加1-2斤，女性每月体重增加0.5-1斤。如果你想要尽可能少长脂肪，前述体重增速还可以再减少点。
...
不过，如果正好开始吃肌酸，最初一个月内大约会吸水长体重1kg甚至更多一点，这是假性的体重增加，需要从体重变化里扣除。例如，开始稳定吃肌酸的第一个月，增肌可能会多长1kg体重，都是吸水导致的假性体重，但一个月后就不可能还在吸水了。`,
    ...
    {
      q: `为什么要新手初期要定量饮食？`,
      a: `因为新手对日常食物的碳蛋脂量没有概念，按感觉吃饭大概率会导致碳蛋脂的总量严重错误。如果按感觉吃饭能八九不离十，那大家也不会有增肌体重不长，或者增长过快长成胖子的问题了。在对照教程视频（B站里搜BV1zu4m1N76R），用本套表的饮食表算好食物重量后，你需要买个食物称，在初期（用几天到一周的时间）做定量饮食。建立饮食习惯后就不需要定量饮食了。这个步骤是必要的。

当然，增肌饮食的精确度要求比减脂更低，因为增肌期的热量摄入要高得多，对因为定量错误、食物错误导致的饮食热量的容错更高，所以增肌饮食不用过于精细和紧张。`,
    },
    {
      q: `难道要一直称重吃饭？食物是生重还是熟重？`,
      a: `不要理解成一直天天顿顿用食物称来称重，而是初期把你经常性食物测一下就行了：
...
【蓝莓】碳水15g/盒`,
    ...
    {
      q: `表格里哪些食物如果不定量会被严重错估？`,
      a: `【面条/米线/卷饼（烙饼、炊饼、馕等）】容易被低估碳水量。这些是饱腹感最低的主食，一份的碳水量高达80-160g，一顿能吃很多但还感觉不出来。增肌也只有碳水量最大的练后餐会考虑作为主食（饱腹感会比较低，对吃不下碳水的人比较有利）。如果经常要吃，请务必自己定量一次。碳水率：熟面条23%，凉面和米线33%，未下锅的生鲜面50%，未下锅的干面70%，卷饼（烙饼、炊饼、馕等）50%。
...
【个别特殊菜肴】容易被低估脂肪量。绝大部分家常菜带油是无妨的，但个别几道菜需要回避：a.炒鸡蛋（例如西红柿炒鸡蛋），一个鸡蛋加上吸油量脂肪动辄30g，会花完全天脂肪配额的一半甚至更多，一定要回避。如果非吃炒鸡蛋不可，请自己在家用两三克油去做。b.炒茄子，茄子是能极度吸油，倒多少油进去，起锅时会被吸干，一般回避这道菜。c.油炸菜，如炸蘑菇、炸酥肉、炸鸡炸鱼炸虾、猪大排（大排也是先油炸过的）。`,
    ...
    {
      q: `哪些食物是需要特别提醒的？`,
      a: `【糖油混合物】面粉+油制作的食物，一般碳水率30%-50%，脂肪率20%-40%。举例：饼干、蛋糕、点心、糕点、甜品、油条、煎饼、花式面包、膨化食品等。如果要吃，只能用来解馋尝尝，要靠这些东西吃饱的话，脂肪摄入会爆炸。
...
【水果】水果的实质是糖水（蔗糖/果糖/葡萄糖+水），要占据碳水配额。吃水果就是吃糖，要置换出主食的碳水出来，置换办法和数据见饮食表格指导。`,
    ...
    {
      q: `吃外卖该怎么办？`,
      a: `【正确的外卖】单独的主食+较多的瘦肉，这样才方便定量。外卖米饭，长方形盒碳水90g/盒，圆形盒碳水75g/盒，瘦肉量自己称重定一下看够不够，如果不够，考虑加一份肉，或者其他几餐多吃点蛋白质。建议先固定几家外卖，不要天天换来换去，以免定量麻烦。搜索关键词：跷脚牛肉、酸菜鱼、沙县、各种带“鸡”字的（黄焖鸡、蒸鸡、烤鸡、窑鸡、鸡腿等）。
...
【错误的外卖】①缺乏瘦肉的外卖，比如面条、米线、盖饭；②混合餐外卖，比如轻食、健康餐，N种食物全部搅拌在一起，让你无法定量；③高脂肉外卖：以本表列出的高脂肉作为肉类的外卖，都不应作为日常食物，包括猪大排、糖醋里脊、锅包肉、炸鸡、烤肉、午餐肉、肥牛、肥羊、排骨、牛排、肉肠、肉饼、肉馅、肉丸等。`,
    ...
    {
      q: `食堂外卖的瘦肉量吃不够怎么办？`,
      a: `吃食堂外卖，碳水和脂肪都不会缺的，容易缺的是瘦肉，如果确实找不到瘦肉，该怎么满足蛋白质摄入呢：①自己卤或者在熟食店买一些鸡腿/酱牛肉之类的瘦肉，放冰箱里，每天带点去食堂补充；②电商买真空包装的速食鸡胸肉/牛肉，但会比较难吃；②蛋白粉替代，蛋白粉的蛋白质率高达约80%，吃一点就相当于吃了不少瘦肉。

但必须提醒，如果你因为吃卤肉/蛋白粉而不怎么吃大众带油炒菜的话，则属于表格里【脂肪缺乏2】的情况，请参照表格指导来补充脂肪摄入。`,
    },
    {
      q: `在外就餐怎么办？`,
      a: `在外就餐不影响减脂，更不会影响增肌了。在外就餐桌上摆的还是碳蛋脂，只是无法定量而已，影响不大。碳水量参考你既往的主食量来吃即可，瘦肉量可以比较随意，蔬菜随意。
...
特别需要注意的就是少吃不吃【高脂肉】和【糖油混合物】。例如，吃火锅、烤肉就点店里最瘦的肉，配一点主食和蔬菜，而不是吃五花肉、肥牛、肥羊、炸酥肉、炸馒头、炸糍粑、锅盔等。当然，增肌期需要热量盈余，对“脏”食物的容纳能力肯定比减脂期强一些，有时候吃吃也无妨，但仍然不能作为基础食物。`,
    ...
    {
      q: `增肌期需要在体重增加后调整饮食配额吗？`,
      a: `一般不需要。这是因为，体重增加10kg，基础代谢才增加约100多大卡，这时候都未必抹平了热量盈余。而我们增肌期一般不会体重增加10kg以上，所以一旦最初的饮食热量是能让体重缓长的，那么整个增肌期都不用太调整配额。确实体重完全停滞了，就按问答1“执行了一个月但体重不长该怎么调整”去增加一笔饮食热量。

而减脂期不同，大体重减脂的体重很可能有数个10kg，所以他们就需要在体重降低超过10kg后，随着基础代谢的降低，应该对应降低约100多大卡的饮食配额。`,
    },
    {
      q: `改了力训时间该怎么修改力训日的餐序？`,
      a: `表格设计了四种进餐：早饭、练前餐、练后餐、其他餐，各自有配额，如果力训时间点改了，各餐换位置即可
【早饭后练（早起版）】早饭（练前餐）-训练-练后餐-午饭（其他餐）-晚饭（其他餐）
...
如果确实非常关心自己的脂肪和肌肉量，一定要得到一个可靠的数字，可以去医院挂营养科或者骨科，要求用“双能X射线吸收法”（DEXA）测身体成分，这个机器本身是用于测骨密度的，因此一般医院都能做，价格不贵约100元左右。但此法只用于那些一定要得知自己身体成分数字的人，并不是增肌减脂就需要去测。`,
    ...
    {
      q: `增肌到什么程度应该转减脂？`,
      a: `停止增肌的标准主要取决于个人审美。BMI=体重kg÷身高m÷身高m，如果介意发胖，男性23<BMI<24，女性21<BMI<22就可以考虑减脂；如果不介意发胖，可以继续增到男性24<BMI<25，女性22<BMI<23再考虑减脂；但一般不建议增到更高体重了，除非是个人有强烈意愿。`,
    },
    {
      q: `高尿酸/痛风患者建议怎样处理饮食？`,
      a: `蛋白质来源里鸡蛋、牛奶、蛋白粉是没嘌呤的，肉类里猪牛羊嘌呤较低，建议：
...
所以，这些“增肌减脂同时进行”的情况确实存在，但并不是大家希望的那样“增肌和减脂两头都同时最大化，用一倍的时间达成别人两倍时间的效果”，否则，健身就不需要分为“增肌期”和“减脂期”了，大家所有时间都应该是“增肌减脂同时进行期”。总之，该减脂就减脂，该增肌就增肌，而不用去想要“两头都要同时最大化”。`,
    ...
    {
      q: `有什么低热量能短暂填肚子的零食？`,
      a: `如果你是体重停滞不涨，需要加饮食热量，请参考问答1“执行了一个月但体重不长该怎么调整”去加饮食热量。这里说的低热量零食，不是为了加饮食热量的，而是用于体重增速已经合适（说明饮食热量是合适的），但还想额外吃零食夜宵的情况。
